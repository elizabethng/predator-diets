...
Load the data, omitting the first column, which is simply a unique ID from the database (I assume).  Also note, they are not consecutive entries probably because Brian just pulled out the top 14 herring predators.  
