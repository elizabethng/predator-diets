...
covar_columns <- trawlrun$covar_columns
use_aniso <- trawlrun$use_aniso
config_file_loc <- trawlrun$config_file_loc
strata_file_loc <- here("configuration-files", "strata_limits_subset.R")
processed_data <- trawlrun$processed_data[[1]]
output_file_loc <- trawlrun$output_file_loc
