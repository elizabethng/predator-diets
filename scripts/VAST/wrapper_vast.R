ss_wrapper_vast = function(species_num, file_prefix, Save_output = FALSE, ObsModel = c(2,1)){
  ...
  Species = c("SILVER HAKE", "RED HAKE", "FOURSPOT FLOUNDER", "ATLANTIC COD", 
              ...
              "GOOSEFISH", "THORNY SKATE", "SEA RAVEN", "BLUEFISH", "WEAKFISH")[species_num]
  
  Species_name = gsub(" ", "_", Species)
  
  
  # 0. Create output directory ----------------------------------------------
  DateFile = paste("output", "VAST", paste0(file_prefix, Species_name), sep = "/")
