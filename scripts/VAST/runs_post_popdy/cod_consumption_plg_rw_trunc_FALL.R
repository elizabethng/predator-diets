# FALL A includes Fall and Summer
# Truncate to start in 1985 since there are 0 obs 1976-1977 and 1980 to 1984
...
DateFile = paste("output", "VAST", "_runs_post_popdy", "cod_consumption_plg_rw_trunc_FALL", sep = "/")
