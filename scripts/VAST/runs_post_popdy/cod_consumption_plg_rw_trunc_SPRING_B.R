# Try fitting Spring with Spring and Summer
# (SPRING A includes Winter and Spring and doesn't run)
# Truncate to start in 1979 since there are zero observations in 1977 and 1978
...
DateFile = paste("output", "VAST", "_runs_post_popdy", "cod_consumption_plg_rw_trunc_SPRING_B", sep = "/")
