...
DateFile = here::here(paste0("output/VAST/VAST_draft_analysis"))
dir.create(DateFile)
```
...
Also try usin gthe `observations_LL` which will probaly generate knots during the run, but would probably give different results each time because the algorithm is stochastic.  
```{r}
